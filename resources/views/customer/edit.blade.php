        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card border-0 shadow rounded">
                    <div class="card_header p-3 fs-5 bg-light">Form Edit Data Customer</div>
                    <div class="card-body">
                        <form action="{{ route('customer.update',$customer->id_customer) }}" method="POST">
                            ...
                            <div class="form-group mt-2">
                                ...
                                <input type="text" class="form-control @error('jenis_kelamin') is-invalid @enderror"
                                    name="jenis_kelamin" value="{{ old('jenis_kelamin',$customer->jenis_kelamin) }}"
                                    required>
                            ...
                            <div class="form-group  mt-2">
                                ...
                                <input type="date" class="form-control @error('tgl_lahir') is-invalid @enderror"
                                    name="tgl_lahir" value="{{ old('tgl_lahir',$customer->tgl_lahir) }}" required>
                            ...
                            <div class="form-group mt-2">
                                ...
                                <input type="text" class="form-control @error('username') is-invalid @enderror"
                                    name="username" value="{{ old('username',$customer->username) }}" required>
